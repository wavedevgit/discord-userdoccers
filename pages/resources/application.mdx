...
<RouteHeader method="POST" url="/networking/token">
  Create Networking Token
</RouteHeader>

Creates a short-lived networking token.

###### Response Body

| Field | Type   | Description                      |
| ----- | ------ | -------------------------------- |
| token | string | The short-lived networking token |

<RouteHeader method="GET" url="/applications/{application.id}/trusted-links/check">
  List Activities Trusted Links
</RouteHeader>

Returns whether the URL is trusted for the application.
...
| Field   | Type    | Description                |
| ------- | ------- | -------------------------- |
| trusted | boolean | Whether the URL is trusted |

<RouteHeader method="POST" url="/applications/{application.id}/proxy-tickets">
  Create Application Proxy Ticket
</RouteHeader>

Creates a short-lived proxy ticket for an application. Returns an object containing a `ticket` string.
