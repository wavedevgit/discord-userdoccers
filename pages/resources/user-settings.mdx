...
<RouteHeader method="DELETE" url="/users/@me/notification-settings/snapshots/{notification_settings_snapshot.id}">
...
<RouteHeader method="DELETE" url="/users/@me/video-filters/assets/{video_filter_asset.id}">
  Delete Video Filter Asset
</RouteHeader>

Deletes a video filter asset. Returns a 204 empty response on success.

<RouteHeader method="POST" url="/users/@me/video-filters/assets/{video_filter_asset.id}/last-used">
