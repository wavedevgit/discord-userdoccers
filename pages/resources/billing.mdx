...
<RouteHeader method="GET" url="/{resource.id}/billing/premium/subscribe/login-handoff">
  Get Standalone Checkout Login Handoff
</RouteHeader>

Returns the login handoff for a standalone premium checkout.

###### Query String Params

| Field         | Type   | Description                         |
| ------------- | ------ | ----------------------------------- |
| handoff_key   | string | The checkout handoff key            |
| handoff_token | string | The checkout handoff token          |
| destination   | string | The destination to open after login |
...
<RouteHeader method="GET" url="/users/@me/billing/payment-source-creation-context">
...
<RouteHeader method="GET" url="/users/@me/billing/eligible-application-subscription-guilds">
...
Returns the gift card details.

###### JSON Params

| Field | Type   | Description       |
| ----- | ------ | ----------------- |
| pin   | string | The gift card PIN |
...
| country_code | string | The billing country code |

###### Response Body

| Field    | Type    | Description                                 |
| -------- | ------- | ------------------------------------------- |
| amount   | integer | The amount redeemed in minor currency units |
| currency | string  | The lowercase ISO 4217 currency code        |
