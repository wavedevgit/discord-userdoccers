...
| Field        | Type                                                                           | Description                                   |
| ------------ | ------------------------------------------------------------------------------ | --------------------------------------------- |
| applications | array[partial [application](/resources/application#application-object) object] | The applications with featured widget configs |
| configs      | array[[widget config](#widget-config-structure) object]                        | The featured widget configs                   |
...
| Field        | Type                                                                           | Description                                |
| ------------ | ------------------------------------------------------------------------------ | ------------------------------------------ |
| applications | array[partial [application](/resources/application#application-object) object] | The developer's applications               |
| configs      | array[[widget config](#widget-config-structure) object]                        | The developer applications' widget configs |
...
<RouteHeader method="POST" url="/users/@me/widgets/assets/upload">
  Request User Profile Widget Asset Upload
</RouteHeader>

Creates an upload URL for a widget asset.
...
| Field           | Type   | Description                                |
| --------------- | ------ | ------------------------------------------ |
| upload_url      | string | The presigned URL used to upload the file  |
| upload_filename | string | The filename assigned to the uploaded file |

<RouteHeader method="POST" url="/users/@me/widgets/clips/upload">
  Request User Profile Widget Clip Upload
</RouteHeader>

Creates an upload URL for a widget clip.
...
| Field           | Type   | Description                                |
| --------------- | ------ | ------------------------------------------ |
| upload_url      | string | The presigned URL used to upload the clip  |
| upload_filename | string | The filename assigned to the uploaded clip |
