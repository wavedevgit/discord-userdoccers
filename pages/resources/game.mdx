...
The games APIs extend application resources to power game detection, search, and rich presence features.
...
Returns games matching the normalized query.

###### Query String Params

| Field | Type   | Description           |
| ----- | ------ | --------------------- |
| q     | string | The game search query |

###### Game Search Result Structure

| Field | Type      | Description                                       |
| ----- | --------- | ------------------------------------------------- |
| id    | snowflake | The ID of the game application                    |
| name  | string    | The name of the game                              |
| icon  | ?string   | The game's [icon hash](/reference#cdn-formatting) |
