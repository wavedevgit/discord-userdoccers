...
<RouteHeader method="GET" url="/oauth2/authorize/webhook-channels">
  List OAuth2 Authorize Webhook Channels
</RouteHeader>

Returns oauth2 authorize webhook channels.
...
<RouteHeader method="POST" url="/oauth2/account-linking-achievement">
  Create Account Linking Achievement
</RouteHeader>

Creates an account-linking achievement.
